...
<template>
    <el-form-item :prop="prop" label-position="top">
        ...
        <div class="input-container" :class="{
            ...
            <el-input size="large" v-if="!isFocused" v-model.number="inputValue" @focus="handleFocus"
            ...
            <el-input v-else v-model.number="inputValue" placeholder="Vui lòng nhập" type="textarea" :autosize="{ minRows: 3, maxRows: 6 }"
